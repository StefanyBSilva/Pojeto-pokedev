...
listaSelecaoPokedevs.forEach(pokedev => {
	pokedev.addEventListener("click", () => {
		...
		const idPokedevSelecionado = exibirCartaoPokedevSelecionado(pokedev);
...
//refatoração feita para diminuir o codigo.
...
function exibirCartaoPokedevSelecionado(pokedev) {
